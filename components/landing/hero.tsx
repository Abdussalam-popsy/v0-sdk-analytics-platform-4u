    ...
    <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative mx-auto max-w-7xl px-6 text-center">
        ...
        <div className="mx-auto mt-20 max-w-5xl">
          <div className="rounded-xl border border-border/60 bg-card/50 p-1 shadow-2xl shadow-primary/5 backdrop-blur-sm">
            <div className="grid gap-1 md:grid-cols-2">
              ...
              <div className="relative rounded-lg bg-muted/30 p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="mt-6 h-32 rounded-lg bg-primary/10" />
                  <div className="flex gap-3">
